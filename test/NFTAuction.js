...
contract(
  "NFTAuction",
  ([owner, buyer, buyer1, feeRecipient, RoyaltyFeeRecipient]) => {
    beforeEach(async () => {
    ...
    it("Auction", async () => {
      ...
      await expectRevert(
        this.nftAuction.bid(this.nft.address, 1000, this.usdt.address, 100, {
          from: buyer,
        }),
      ...
      await expectRevert(
        this.nftAuction.bid(this.nft.address, 10001, this.usdt.address, 100, {
          from: buyer,
        }),
      ...
      await expectRevert(
        this.nftAuction.bid(this.nft.address, 1000, this.usdt.address, 1, {
          from: buyer,
        }),
      ...
      await expectRevert(
        this.nftAuction.bid(this.nft.address, 1000, this.beco.address, 2, {
          from: buyer,
        }),
        "ERC721NFTAuction: invalid quote token"
      );

      await this.nftAuction.bid(this.nft.address, 1000, this.usdt.address, 50, {
        from: buyer1,
      });

      await expectRevert(
        this.nftAuction.bid(this.nft.address, 1000, this.beco.address, 50, {
          from: buyer,
        }),
      ...
      await expectRevert(
        this.nftAuction.collect(this.nft.address, 1000),
    ...
    it("Bid: zero price", async () => {
      ...
      await expectRevert(
        this.nftAuction.bid(this.nft.address, 1000, this.usdt.address, 0, {
          from: buyer,
        }),
    ...
    it("Collect: no bidder", async () => {
      ...
      await expectRevert(
        this.nftAuction.collect(this.nft.address, 1000, { from: buyer }),
    ...
    it("Cancel Auction", async () => {
      ...
      await expectRevert(
        this.nftAuction.cancelAuction(this.nft.address, 1000, { from: buyer }),
        "ERC721NFTAuction: only seller"
      );

      await this.nftAuction.cancelAuction(this.nft.address, 1000);
      ...
      await this.nftAuction.bid(this.nft.address, 1000, this.usdt.address, 99, {
        from: buyer,
      });

      await expectRevert(
        this.nftAuction.cancelAuction(this.nft.address, 1000),
    ...
    it("Auction with eth", async () => {
      ...
      await this.nftAuction.bid(this.nft.address, 1000, this.weth.address, 1, {
        from: buyer1,
        value: 1,
      });

      await this.nftAuction.bid(this.nft.address, 1000, this.weth.address, 2, {
        from: buyer,
        value: 2,
      });
    });
    ...
    it("Only Owner", async () => {
      ...
      await expectRevert(
        this.nftAuction.setProtocolFeeRecipient(this.nft.address, {
          from: buyer,
        }),
        "Ownable: caller is not the owner"
      );
